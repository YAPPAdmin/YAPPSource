<script lang="ts">
    ...
    const show = persistedStore("ui_show_save_actions", true)
    const showSaveExpl = persistedStore("ui_show_save_expl", false);
</script>
...
<div class="w-full max-w-sm">
    ...
    {#if $show}
        ...
        <div class="w-full" transition:slide={{ duration: 200 }}>
            ...
            {#if $showSaveExpl}
                <p class="text-gray-500 text-xs! leading-relaxed!" transition:slide={{ duration: 200 }}>
